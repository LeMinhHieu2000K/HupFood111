                ...
                <div class="testimonial-slider slider-arrow">
                    <div class="testimonial-card"><i class="fas fa-quote-left"></i>
                        ...
                        <ul>
                            ...
                            <li class="fas fa-star"></li>
                            <li class="fas fa-star"></li>
                        </ul><img src="assets/images/avatar/01.jpg" alt="testimonial">
                    </div>
                    <div class="testimonial-card"><i class="fas fa-quote-left"></i>
                        <p>Lorem ipsum dolor consectetur adipisicing elit neque earum sapiente vitae obcaecati
                            magnam doloribus magni provident ipsam</p>
                        ...
                        <ul>
                            ...
                            <li class="fas fa-star"></li>
                            <li class="fas fa-star"></li>
                        </ul><img src="assets/images/avatar/02.jpg" alt="testimonial">
                    </div>
                    <div class="testimonial-card"><i class="fas fa-quote-left"></i>
                        <p>Lorem ipsum dolor consectetur adipisicing elit neque earum sapiente vitae obcaecati
                            magnam doloribus magni provident ipsam</p>
                        ...
                        <ul>
                            ...
                            <li class="fas fa-star"></li>
                            <li class="fas fa-star"></li>
                        </ul><img src="assets/images/avatar/03.jpg" alt="testimonial">
                    </div>
                    <div class="testimonial-card"><i class="fas fa-quote-left"></i>
                        <p>Lorem ipsum dolor consectetur adipisicing elit neque earum sapiente vitae obcaecati
                            magnam doloribus magni provident ipsam</p>
                        ...
                        <ul>
                            ...
                            <li class="fas fa-star"></li>
                            <li class="fas fa-star"></li>
                        </ul><img src="assets/images/avatar/04.jpg" alt="testimonial">
                    </div>
                </div>
            </div>
        </div>
